...
public class AddCours extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddCours</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddCours at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            ch =g.ajout_cours(id, h, mat, prof, salle);
            
            req.setAttribute( "add", ch);
           
         RequestDispatcher dispatcher = req.getServletContext().getRequestDispatcher("/addcours.jsp");			
