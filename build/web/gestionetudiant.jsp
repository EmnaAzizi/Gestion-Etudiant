...
.myButton:active {
    ...
    <br> <br> 
      ...
      <fieldset id="fieldset" class="hide">
          ...
          <legend id="legend">Vous avez selectioné : Recherche Etudiant</legend>
    <div id="placeholder">
        <div id="template">
  <form Action="/tpp/rechercheEtudiant" method="post">
    ...
    <button type="Submit">Rechercher</button></p>
      ...
      <fieldset id="fieldset1" class="hide">
          ...
          <legend id="legend">Vous avez selectioné : Supprimer Etudiant</legend>
    <div id="placeholder">
        <div id="template">
  <form Action="/tpp/SupprimerEtudiant1" method="post">
            <p>Entrer l'ID de l'Etudiant à Supprimer: &nbsp; <input type ="text" size="25" name="id" /><br /></p>   
        </div> <!-- template -->
    </div> <!-- placeholder -->
